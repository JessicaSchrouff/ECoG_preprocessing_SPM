%-----------------------------------------------------------------------
% Job saved on 23-Sep-2015 16:41:47 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6470)
...
matlabbatch{1}.spm.meeg.convert.outfile = '<UNDEFINED>';
matlabbatch{1}.spm.meeg.convert.eventpadding = 0;
matlabbatch{1}.spm.meeg.convert.blocksize = 3276800;
matlabbatch{1}.spm.meeg.convert.checkboundary = 0;
