function d = LBCN_smooth_data(files,win_length, time_win)
...
for i = 1:size(files,1)
    ...
    if nargin<3 || isempty(time_win)
        ...
        time_win = time_win/1000;
        t1 = D.indsample(time_win(1));
        t2 = D.indsample(time_win(2));
        t_win = t1:t2;
    end
    ...
    Dnew = timeonset(Dnew,time_win(1));
    D = Dnew;
    save(D);
    d{i} = D;
end