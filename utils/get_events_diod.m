...
function [evt] = get_events_diod(fname, ichan, skip_before, skip_after, thresh_dur)
...
if nargin<4
    skip_after = 0; % do not discard events at the end
end

if nargin<5
    thresh_dur = def.thresh_dur; % minimum duration of an event
end
